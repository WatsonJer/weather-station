  ...
  <VContainer class="fill-height" align="center" justify="center">
    <VResponsive>
      <VRow align="center" justify="center">
        <VCol style="max-width: 550px" align="start"
      ...
      <VRow>
        <VCol>
          <span class="text-caption text-medium-emphasis text-error">{{
            typing
          }}</span>
        </VCol>
      </VRow>
...
const firstname = ref("Marcus");
const lastname = ref("Garvey");
const typing = ref("");
let timeoutVal = 1000;
let nameID;
