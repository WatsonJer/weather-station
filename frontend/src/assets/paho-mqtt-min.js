  ...
  "object" === typeof exports && "object" === typeof module
    ...
    : "function" === typeof define && define.amd
      ...
      : "object" === typeof exports
        ? (exports = s())
        : ("undefined" === typeof p.Paho && (p.Paho = {}), (p.Paho.MQTT = s()));
})(this, function () {
  return (function (p) {
    function s(a, b, c) {
      b[c++] = a >> 8;
    ...
    function E(a, b, c) {
      for (var k = "", e, g = b; g < b + c; ) {
        ...
        if (!(128 > e)) {
          ...
          if (0 > m)
            throw Error(
              f(h.MALFORMED_UTF, [e.toString(16), m.toString(16), ""]),
            );
        ...
        65535 < e &&
          ((e -= 65536),
          (k += String.fromCharCode(55296 + (e >> 10))),
          (e = 56320 + (e & 1023)));
        ...
        for (var c in a)
          if (a.hasOwnProperty(c))
            if (b.hasOwnProperty(c)) {
              if (typeof a[c] !== b[c])
                throw Error(f(h.INVALID_TYPE, [typeof a[c], c]));
            } else {
      ...
      f = function (a, b) {
        ...
        if (b)
          for (var k, e, g = 0; g < b.length; g++)
            if (((k = "{" + g + "}"), (e = c.indexOf(k)), 0 < e))
              var h = c.substring(0, e),
    ...
    q.prototype.encode = function () {
      ...
      switch (this.type) {
        case 1:
          ...
          void 0 !== this.willMessage &&
            ((b += n(this.willMessage.destinationName) + 2),
            (e = this.willMessage.payloadBytes),
            e instanceof Uint8Array || (e = new Uint8Array(h)),
            (b += e.byteLength + 2));
          void 0 !== this.userName && (b += n(this.userName) + 2);
          void 0 !== this.password && (b += n(this.password) + 2);
          break;
        case 8:
          for (var a = a | 2, g = 0; g < this.topics.length; g++)
            ((c[g] = n(this.topics[g])), (b += c[g] + 2));
        ...
        case 3:
          ...
          h instanceof ArrayBuffer
            ? (h = new Uint8Array(h))
            : h instanceof Uint8Array || (h = new Uint8Array(h.buffer));
      }
      var f = b,
        g = Array(1),
        d = 0;
      ...
      void 0 !== this.messageIdentifier &&
        (f = s(this.messageIdentifier, d, f));
      switch (this.type) {
        case 1:
          ...
          void 0 !== this.willMessage &&
            ((f = u(
              ...
              n(this.willMessage.destinationName),
              d,
              f,
            )),
            (f = s(e.byteLength, d, f)),
            d.set(e, f),
            (f += e.byteLength));
          void 0 !== this.userName &&
            (f = u(this.userName, n(this.userName), d, f));
        ...
        case 8:
          for (g = 0; g < this.topics.length; g++)
            ((f = u(this.topics[g], c[g], d, f)),
              (d[f++] = this.requestedQos[g]));
          break;
        case 10:
          for (g = 0; g < this.topics.length; g++)
            f = u(this.topics[g], c[g], d, f);
    ...
    var F = function (a, b, c) {
      ...
      d = function (a, b, c, d, e) {
        if (!("WebSocket" in p && null !== p.WebSocket))
          throw Error(f(h.UNSUPPORTED, ["WebSocket"]));
        if (!("localStorage" in p && null !== p.localStorage))
          throw Error(f(h.UNSUPPORTED, ["localStorage"]));
        if (!("ArrayBuffer" in p && null !== p.ArrayBuffer))
          throw Error(f(h.UNSUPPORTED, ["ArrayBuffer"]));
        ...
        for (var g in localStorage)
          (0 !== g.indexOf("Sent:" + this._localKey) &&
            0 !== g.indexOf("Received:" + this._localKey)) ||
            this.restore(g);
      };
    ...
    d.prototype.connect = function (a) {
      ...
      if (this.connected)
        throw Error(f(h.INVALID_STATE, ["already connected"]));
    ...
    d.prototype.subscribe = function (a, b) {
      ...
      b.timeout &&
        (c.timeOut = new w(this, window, b.timeout, b.onFailure, [
          {
            invocationContext: b.invocationContext,
    ...
    d.prototype.send = function (a) {
      ...
      if (this.connected)
        ...
        if (
          ...
          throw Error(f(h.BUFFER_FULL, [this.disconnectedBufferSize]));
        0 < a.qos
          ? this._requires_ack(wireMessage)
    ...
    d.prototype.disconnect = function () {
      ...
      this._reconnecting &&
        ...
        (this._reconnecting = !1));
      if (!this.socket)
        throw Error(f(h.INVALID_STATE, ["not connecting or connected"]));
      wireMessage = new q(14);
      this._notify_msg_sent[wireMessage] = v(this._disconnected, this);
      this._schedule_message(wireMessage);
    };
    ...
    d.prototype._doConnect = function (a) {
      ...
      this._connectTimeout = new w(
        this,
        window,
        this.connectOptions.timeout,
        this._disconnected,
        [h.CONNECT_TIMEOUT.code, f(h.CONNECT_TIMEOUT)],
      );
    };
    ...
    d.prototype.store = function (a, b) {
      ...
      switch (b.type) {
        case 3:
          ...
          c.payloadMessage = {};
          for (
            var d = "", e = b.payloadMessage.payloadBytes, g = 0;
            g < e.length;
            g++
          )
            d =
              15 >= e[g] ? d + "0" + e[g].toString(16) : d + e[g].toString(16);
    ...
    d.prototype.restore = function (a) {
      ...
      0 === a.indexOf("Sent:" + this._localKey)
        ? ((d.payloadMessage.duplicate = !0),
          (this._sentMessages[d.messageIdentifier] = d))
        : 0 === a.indexOf("Received:" + this._localKey) &&
          (this._receivedMessages[d.messageIdentifier] = d);
    };
    ...
    d.prototype._deframeMessages = function (a) {
      ...
      try {
              ...
              switch (l) {
                ...
                case 3:
                  var m = (t >> 1) & 3,
                    ...
                    g = g + s;
                  0 < m &&
                    ((y.messageIdentifier = 256 * e[g] + e[g + 1]), (g += 2));
        ...
        d =
          "undefined" == w.hasOwnProperty("stack")
            ? w.stack.toString()
            : "No Error Stack Available";
        this._disconnected(
          h.INTERNAL_ERROR.code,
          f(h.INTERNAL_ERROR, [w.message, d]),
        );
        return;
      }
      return b;
      ...
      try {
        switch (a.type) {
          case 2:
            ...
            if (this.connectOptions.cleanSession) {
              ...
              for (b in this._receivedMessages) {
                ...
                localStorage.removeItem(
                  "Received:" + this._localKey + d.messageIdentifier,
                );
              }
              this._receivedMessages = {};
            }
            if (0 === a.returnCode)
              ...
              this._disconnected(
                h.CONNACK_RETURNCODE.code,
                f(h.CONNACK_RETURNCODE, [a.returnCode, H[a.returnCode]]),
              );
              break;
            }
            a = [];
            ...
            if (0 < this._buffered_msg_queue.length) {
              e = null;
              for (var g = this._buffered_msg_queue.reverse(); (e = g.pop()); )
                (a.push(e),
                  this.onMessageDelivered &&
                    (this._notify_msg_sent[e] = this.onMessageDelivered(
                      e.payloadMessage,
                    )));
            }
            ...
            for (var g = 0, m = a.length; g < m; g++)
              if (((c = a[g]), 3 == c.type && c.pubRecReceived)) {
                var n = new q(6, { messageIdentifier: c.messageIdentifier });
          ...
          case 5:
            if ((c = this._sentMessages[a.messageIdentifier]))
              ((c.pubRecReceived = !0),
                (n = new q(6, { messageIdentifier: a.messageIdentifier })),
                this.store("Sent:", c),
                this._schedule_message(n));
            break;
          case 6:
            ...
            d &&
              (this._receiveMessage(d),
              delete this._receivedMessages[a.messageIdentifier]);
            var l = new q(7, { messageIdentifier: a.messageIdentifier });
          ...
          case 14:
            this._disconnected(
              h.INVALID_MQTT_MESSAGE_TYPE.code,
        ...
        ((c =
          "undefined" == t.hasOwnProperty("stack")
            ? t.stack.toString()
            : "No Error Stack Available"),
          this._disconnected(
            h.INTERNAL_ERROR.code,
            f(h.INTERNAL_ERROR, [t.message, c]),
          ));
      }
    };
    d.prototype._on_socket_error = function (a) {
      this._reconnecting ||
        this._disconnected(h.SOCKET_ERROR.code, f(h.SOCKET_ERROR, [a.data]));
    };
    ...
    d.prototype._receivePublish = function (a) {
      switch (a.payloadMessage.qos) {
        ...
        case 0:
          ...
          break;
        case 1:
          var b = new q(4, { messageIdentifier: a.messageIdentifier });
        ...
        case 2:
          ...
          a = new q(5, { messageIdentifier: a.messageIdentifier });
    ...
    d.prototype._reconnect = function () {
      ...
      this.connected ||
        ...
        128 > this._reconnectInterval && (this._reconnectInterval *= 2),
        this.connectOptions.uris
    ...
    d.prototype._disconnected = function (a, b) {
      ...
      if (void 0 !== a && this._reconnecting)
        this._reconnectTimeout = new w(
          this,
          window,
        ...
        (void 0 === a && ((a = h.OK.code), (b = f(h.OK))), this.connected)
      ) {
        this.connected = !1;
      ...
      if (this.traceFunction) {
        for (var a in arguments)
          "undefined" !== typeof arguments[a] &&
            arguments.splice(a, 1, JSON.stringify(arguments[a]));
    ...
    var G = function (a, b, c, k) {
      var e;
      if ("string" !== typeof a)
        throw Error(f(h.INVALID_TYPE, [typeof a, "host"]));
      if (2 == arguments.length) {
        ...
        if ("number" !== typeof b || 0 > b)
          throw Error(f(h.INVALID_TYPE, [typeof b, "port"]));
        if ("string" !== typeof c)
          throw Error(f(h.INVALID_TYPE, [typeof c, "path"]));
        e =
          "ws://" +
      ...
      if ("string" !== typeof k || 65535 < g)
        throw Error(f(h.INVALID_ARGUMENT, [k, "clientId"]));
      ...
      this.connect = function (a) {
        ...
        if (void 0 !== a.password && void 0 === a.userName)
          throw Error(
            f(h.INVALID_ARGUMENT, [a.password, "connectOptions.password"]),
          );
        if (a.willMessage) {
          if (!(a.willMessage instanceof r))
            throw Error(
              f(h.INVALID_TYPE, [a.willMessage, "connectOptions.willMessage"]),
            );
        ...
        if (a.hosts) {
          if (!(a.hosts instanceof Array))
            throw Error(
              f(h.INVALID_ARGUMENT, [a.hosts, "connectOptions.hosts"]),
            );
          if (1 > a.hosts.length)
            throw Error(
              f(h.INVALID_ARGUMENT, [a.hosts, "connectOptions.hosts"]),
          ...
          if (b) a.uris = a.hosts;
            ...
            if (!a.ports)
              throw Error(
                f(h.INVALID_ARGUMENT, [a.ports, "connectOptions.ports"]),
              );
      ...
      this.subscribe = function (a, b) {
        ...
        if (
          ...
          throw Error(f(h.INVALID_ARGUMENT, [b.qos, "subscribeOptions.qos"]));
        l.subscribe(a, b);
      };
      ...
      this.send = function (a, b, c, d) {
        ...
        if (1 == arguments.length) {
          if (!(a instanceof r) && "string" !== typeof a)
